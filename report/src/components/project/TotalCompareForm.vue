<template>
  <el-form :model="table22" label-width="180px" label-position="right">
    <el-row :gutter="20">
      <el-col :span="8">
...
export default {
  ...
  watch: {
    formData: {
      handler (newValue, oldValue) {
        this.table22 = Object.assign({}, newValue)
      }
    }
  },
  data () {
    return {
      table22: Object.assign({}, this.formData),
  ...
  methods: {
    ...
    // 确定修改
    handleConfirm () {
      this.table22.table22Editor = this.editor
      this.$emit('confirm', this.table22)
    }
  }
}
</script>
