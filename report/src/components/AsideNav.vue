  ...
  <div>
    <el-menu
      ...
      <el-submenu index="/project" v-show="plateId === '2' || plateId === '4'">
        ...
        <el-menu-item index="/project/statistics">成本统计汇总</el-menu-item>
        <el-submenu index="/project/add" v-show="plateId === '2' && role === 'leader'">
          ...
          <el-menu-item index="/project/add/summary">项目成本统计一</el-menu-item>
        ...
        <el-submenu index="/project/all">
          ...
          <el-menu-item index="/project/all/summary">项目成本统计汇总一</el-menu-item>
