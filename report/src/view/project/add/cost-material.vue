<template>
  <el-card shadow="hover">
    ...
    <el-form :model="table9" :rules="rules" ref="table9" label-width="180px" label-position="right" >
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="类型" prop="table9Type">
            <el-select v-model="table9.table9Type" placeholder="请选择调入/调出" value="">
        ...
        <el-col :span="8">
          <el-form-item label="调入/调出材料名称" prop="table9MaterialName">
            <el-input v-model="table9.table9MaterialName" placeholder="请输入材料名称" clearable />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row  :gutter="20">
        <el-col :span="8">
          <el-form-item label="调出单位" prop="table9RecallUnit">
            <el-input v-model="table9.table9RecallUnit" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="调入单位" prop="table9TransferUnit">
            <el-input v-model="table9.table9TransferUnit" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="单位" prop="table9Unit">
            <el-select v-model="table9.table9Unit" filterable allow-create default-first-option placeholder="请选择/输入工程量单位" value="">
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <el-form-item label="工程量" prop="table9WorkQuantity">
            <el-input v-model.number="table9.table9WorkQuantity" type="number" placeholder="请输入工程量" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item :label="type" prop="table9Price">
            <el-input v-model.number="table9.table9Price" type="number" placeholder="请输入单价" clearable><template slot="append">元</template></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="8">
...
export default {
  ...
  data () {
    return {
      ...
      rules: {
        ...
        table9MaterialName: [{ required: true, message: '不可为空', trigger: 'change' }],
        table9RecallUnit: [{ required: true, message: '不可为空', trigger: 'change' }],
        table9TransferUnit: [{ required: true, message: '不可为空', trigger: 'change' }],
        table9Unit: [{ required: true, message: '不可为空', trigger: 'change' }],
        table9WorkQuantity: [{ required: true, message: '请输入工程量', trigger: 'change' }],
        table9Type: [{ required: true, message: '请选择类型', trigger: 'change' }],
        table9Price: [{ required: true, message: '请输入金额', trigger: 'change' }]
      },
  ...
  computed: {
    totalPrice () {
      return this.table9.table9WorkQuantity * this.table9.table9Price
    },
    type () {
      let demo = this.table9.table9Type
      if (demo === '调入') {
        return '调入单位材料折合单价'
      } else if (demo === '调出') {
        return '调出单位材料购买单价'
  ...
  methods: {
    ...
    addTable9 () {
      this.table9.table9TotalPrice = this.totalPrice
